...
var SEND_DTMF_ENDPOINT = exports.SEND_DTMF_ENDPOINT = 'sendDtmf';
...
var _INACTIVE_ = exports._INACTIVE_ = 'INACTIVE';
...
// *********** PARTICIPANT DELTAS ***********
var PARTICIPANT_DELTAS = exports.PARTICIPANT_DELTAS = {
  TARGETS: {
    AUDIO: 'audio',
    VIDEO: 'video'
  },
...
var LAYOUT_TYPES = exports.LAYOUT_TYPES = ['Single', 'Equal', 'ActivePresence', 'Prominent', 'OnePlusN'];
...
var DEFAULT_GET_STATS_FILTER = exports.DEFAULT_GET_STATS_FILTER = {
  types: ['track', 'transport', 'candidate-pair', 'outbound-rtp', 'outboundrtp', 'inbound-rtp', 'inboundrtp', 'remote-inbound-rtp', 'remote-outbound-rtp']
};
...
var SHARE_STOPPED_REASON = exports.SHARE_STOPPED_REASON = {
...
var MEDIA_STATE = exports.MEDIA_STATE = {
  active: 'active',
  inactive: 'inactive'
};
...
var CONNECTION_STATE = exports.CONNECTION_STATE = {
  NEW: 'new',
...
var MEDIA_TRACK_CONSTRAINT = exports.MEDIA_TRACK_CONSTRAINT = {
  CURSOR: {
...
var MEETING_END_REASON = exports.MEETING_END_REASON = {
  INACTIVE: 'INACTIVE',
...
var MediaContent = exports.MediaContent = {
  main: 'main',
  slides: 'slides'
};
...
var NETWORK_STATUS = exports.NETWORK_STATUS = {
  DISCONNECTED: 'DISCONNECTED',
...
var QUALITY_LEVELS = exports.QUALITY_LEVELS = {
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  HIGH: 'HIGH'
};

var VIDEO_RESOLUTIONS = exports.VIDEO_RESOLUTIONS = (_VIDEO_RESOLUTIONS = {}, (0, _defineProperty3.default)(_VIDEO_RESOLUTIONS, QUALITY_LEVELS.LOW, {
  video: {
    width: {
      max: 320,
      ideal: 320
...
}), (0, _defineProperty3.default)(_VIDEO_RESOLUTIONS, QUALITY_LEVELS.MEDIUM, {
  video: {
    width: {
      max: 640,
      ideal: 640
...
}), (0, _defineProperty3.default)(_VIDEO_RESOLUTIONS, QUALITY_LEVELS.HIGH, {
  video: {
    width: {
      max: 1280,
      ideal: 1280
 ...
 */
var MAX_FRAMESIZES = exports.MAX_FRAMESIZES = (_MAX_FRAMESIZES = {}, (0, _defineProperty3.default)(_MAX_FRAMESIZES, QUALITY_LEVELS.LOW, 1620), (0, _defineProperty3.default)(_MAX_FRAMESIZES, QUALITY_LEVELS.MEDIUM, 3600), (0, _defineProperty3.default)(_MAX_FRAMESIZES, QUALITY_LEVELS.HIGH, 8192), _MAX_FRAMESIZES);

/*
*  mqa Interval for sending stats metrics
*/

var MQA_INTEVAL = exports.MQA_INTEVAL = 60000; // mqa analyzer interval its fixed to 60000


// Metrics constants ----------------------------------------------------------

var METRICS_OPERATIONAL_MEASURES = exports.METRICS_OPERATIONAL_MEASURES = {
