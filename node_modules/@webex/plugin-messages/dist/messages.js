  ...
  getMessageEvent: function getMessageEvent(activity, event) {
    try {
      ...
      if (event !== _common.SDK_EVENT.EXTERNAL.EVENT_TYPE.DELETED) {
        ...
        sdkEvent.data.id = (0, _common.constructHydraId)(_common.hydraTypes.MESSAGE, activity.id, cluster);
        if (text) {
        ...
        if (activity.parent && activity.parent.id) {
          sdkEvent.data.parentId = (0, _common.constructHydraId)(_common.hydraTypes.MESSAGE, activity.parent.id, cluster);
        }
      } else {
        sdkEvent.data.id = (0, _common.constructHydraId)(_common.hydraTypes.MESSAGE, activity.object.id, cluster);
      }
