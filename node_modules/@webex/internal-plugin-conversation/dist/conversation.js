...
var Conversation = _webexCore.WebexPlugin.extend({
  ...
  */
  ...
  listActivitiesThreadOrdered: function listActivitiesThreadOrdered(options) {
    ...
    var olderOptions = (0, _extends3.default)({}, baseOptions, { queryType: _activityThreadOrdering.OLDER });
    ...
    var jumpToActivity = function () {
      var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(searchObject) {
        var searchOptions, _ref12, searchResults;
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                searchOptions = (0, _extends3.default)({}, baseOptions, { queryType: _activityThreadOrdering.MID, search: searchObject
                });
    ...
    var getOlder = function () {
      var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
        var _ref14, value, oldestInBatch, moreActivitiesExist;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                value = _ref14.value;
                oldestInBatch = value[0];
                moreActivitiesExist = (0, _activityThreadOrdering.getActivityType)(oldestInBatch) !== _activityThreadOrdering.ACTIVITY_TYPES.CREATE;
        ...
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                newerOptions = (0, _extends3.default)({}, baseOptions, { queryType: _activityThreadOrdering.NEWER });
                _context8.next = 3;
  ...
  _listActivitiesThreadOrdered: function _listActivitiesThreadOrdered() {
    ...
    return _asyncGenerator3.default.wrap( /*#__PURE__*/_regenerator2.default.mark(function _callee9() {
      var _options$minActivitie, minActivities, _options$queryType, queryType, convoUrl, _options$search, search, _bookendManager, setBookends, getNewestAct, getOldestAct, defaultBatchSize, batchSize, _activityManager, getActivityHandlerByKey, getActivityByTypeAndParentId, query, _loop, _ret;
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _options$minActivitie = options.minActivities, minActivities = _options$minActivitie === undefined ? _activityThreadOrdering.defaultMinDisplayableActivities : _options$minActivitie, _options$queryType = options.queryType, queryType = _options$queryType === undefined ? _activityThreadOrdering.INITIAL : _options$queryType;

              // must fetch initially before getting newer activities!

              if (queryType === _activityThreadOrdering.NEWER) {
                queryType = _activityThreadOrdering.INITIAL;
              }

              convoUrl = options.url, _options$search = options.search, search = _options$search === undefined ? {} : _options$search;
              ...
              defaultBatchSize = queryType === _activityThreadOrdering.INITIAL || queryType === _activityThreadOrdering.OLDER ? minActivities : Math.max(_activityThreadOrdering.minBatchSize, Math.ceil(minActivities / 2));
                    ...
                    switch (_context10.prev = _context10.next) {
                      case 0:
                        ...
                        getActivityHandlerByType = function getActivityHandlerByType(type) {
                          ...
                          return (_ACTIVITY_TYPES$ROOT$ = {}, (0, _defineProperty3.default)(_ACTIVITY_TYPES$ROOT$, _activityThreadOrdering.ACTIVITY_TYPES.ROOT, addNewRoot), (0, _defineProperty3.default)(_ACTIVITY_TYPES$ROOT$, _activityThreadOrdering.ACTIVITY_TYPES.REPLY, getActivityHandlerByKey(_activityThreadOrdering.ACTIVITY_TYPES.REPLY)), (0, _defineProperty3.default)(_ACTIVITY_TYPES$ROOT$, _activityThreadOrdering.ACTIVITY_TYPES.EDIT, getActivityHandlerByKey(_activityThreadOrdering.ACTIVITY_TYPES.EDIT)), (0, _defineProperty3.default)(_ACTIVITY_TYPES$ROOT$, _activityThreadOrdering.ACTIVITY_TYPES.REACTION, getActivityHandlerByKey(_activityThreadOrdering.ACTIVITY_TYPES.REACTION)), (0, _defineProperty3.default)(_ACTIVITY_TYPES$ROOT$, _activityThreadOrdering.ACTIVITY_TYPES.REACTION_SELF, getActivityHandlerByKey(_activityThreadOrdering.ACTIVITY_TYPES.REACTION_SELF)), (0, _defineProperty3.default)(_ACTIVITY_TYPES$ROOT$, _activityThreadOrdering.ACTIVITY_TYPES.TOMBSTONE, addNewRoot), (0, _defineProperty3.default)(_ACTIVITY_TYPES$ROOT$, _activityThreadOrdering.ACTIVITY_TYPES.CREATE, addNewRoot), _ACTIVITY_TYPES$ROOT$)[type];
                        };

                        handleNewActivity = function handleNewActivity(activity) {
                          var actType = (0, _activityThreadOrdering.getActivityType)(activity);

                          // ignore deletes
                          if ((0, _activityThreadOrdering.isDeleteActivity)(activity)) {
                            return;
                          }
                        ...
                        handleOlderQuery = function handleOlderQuery(activities) {
                          setBookends(activities, _activityThreadOrdering.OLDER);
                        ...
                        handleNewerQuery = function handleNewerQuery(activities) {
                          ...
                          if (activities.length) {
                            setBookends(activities, _activityThreadOrdering.NEWER);
                            handleNewActivities(activities);
                          }
                        };

                        handleSearch = function handleSearch(activities) {
                          setBookends(activities, _activityThreadOrdering.MID);
                          handleNewActivities(activities);
                        };
                        ...
                        getQueryResponseHandler = function getQueryResponseHandler(type) {
                          ...
                          return (_OLDER$NEWER$MID$INIT = {}, (0, _defineProperty3.default)(_OLDER$NEWER$MID$INIT, _activityThreadOrdering.OLDER, handleOlderQuery), (0, _defineProperty3.default)(_OLDER$NEWER$MID$INIT, _activityThreadOrdering.NEWER, handleNewerQuery), (0, _defineProperty3.default)(_OLDER$NEWER$MID$INIT, _activityThreadOrdering.MID, handleSearch), (0, _defineProperty3.default)(_OLDER$NEWER$MID$INIT, _activityThreadOrdering.INITIAL, handleOlderQuery), _OLDER$NEWER$MID$INIT)[type];
                        };
                            ...
                            while (1) {
                              switch (_context9.prev = _context9.next) {
                                case 0:
                                  ...
                                  if (queryType === _activityThreadOrdering.MID || queryType === _activityThreadOrdering.NEWER) {
                                ...
                                case 52:
                                  ...
                                  for (_iterator5 = (0, _getIterator3.default)(rootActivityHash.values()); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                                    ...
                                    repliesByRootId = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.REPLY, rootId);
                                ...
                                case 75:
                                  ...
                                  if (queryType === _activityThreadOrdering.OLDER) {
                                  ...
                                  currentOldestPublishedDate = (0, _activityThreadOrdering.getPublishedDate)(getOldestAct());
                                  currentNewestPublishedDate = (0, _activityThreadOrdering.getPublishedDate)(getNewestAct());

                                  // we're still building our activity list - derive new query from prior query and start loop again

                                  if (queryType === _activityThreadOrdering.INITIAL) {
                                    query = (0, _activityThreadOrdering.getQuery)(_activityThreadOrdering.OLDER, { oldestPublishedDate: currentOldestPublishedDate, batchSize: batchSize });
                                  } else {
                                  ...
                                  if (queryType === _activityThreadOrdering.MID) {
                      ...
                      case 18:
                        ...
                        getRepliesByParentId = function getRepliesByParentId(replyParentId) {
                          ...
                          var repliesByParentId = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.REPLY, replyParentId);

                          if (!repliesByParentId) {
                            return replies;
                          }

                          var sortedReplies = (0, _activityThreadOrdering.sortActivitiesByPublishedDate)((0, _activityThreadOrdering.getActivityObjectsFromMap)(repliesByParentId));

                          sortedReplies.forEach(function (replyActivity) {
                            var replyId = replyActivity.id;
                            var edit = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.EDIT, replyId);
                            var reaction = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.REACTION, replyId);
                            var reactionSelf = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.REACTION_SELF, replyId);

                            var finalReply = edit || replyActivity;
                            ...
                            var sanitizedFullReply = (0, _activityThreadOrdering.sanitizeActivity)(fullReply);
                        ...
                        orderedRoots = (0, _activityThreadOrdering.sortActivitiesByPublishedDate)((0, _activityThreadOrdering.getActivityObjectsFromMap)(getRootActivityHash()));


                        orderedRoots.forEach(function (rootActivity) {
                          var rootId = rootActivity.id;
                          var replies = getRepliesByParentId(rootId);
                          var edit = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.EDIT, rootId);
                          var reaction = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.REACTION, rootId);
                          var reactionSelf = getActivityByTypeAndParentId(_activityThreadOrdering.ACTIVITY_TYPES.REACTION_SELF, rootId);

                          var finalActivity = edit || rootActivity;
                          ...
                          var sanitizedFullRoot = (0, _activityThreadOrdering.sanitizeActivity)(fullRoot);
                      ...
                      case 24:
                        ...
                        _currentOldestPublishedDate = (0, _activityThreadOrdering.getPublishedDate)(getOldestAct());
                        _currentNewestPublishedDate = (0, _activityThreadOrdering.getPublishedDate)(getNewestAct());
